var noneoneblog = function() {};
noneoneblog.browser = function() {
   ...
   return {//移动终端浏览器版本信息 
        ...
        android: u.indexOf('Android') > -1 && !noneoneblog.browser.linuxNotIsAndroid, //android终端或者uc浏览器
