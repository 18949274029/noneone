...
public class Http4ClientUtil {
    ...
    public static String postPlain(String url, String params) throws IOException {
        return post(url, params, ContentType.DEFAULT_TEXT);
    }
    ...
    public static void main(String[] args) throws IOException {
		...
		String parame = "https://www.noneone.cn/view/372";
		parame +="\n"+"https://www.noneone.cn/view/370";
		System.out.println(Http4ClientUtil.postPlain(url, parame));
	}
