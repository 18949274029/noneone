package noneoneblog.core.hook.interceptor;
...
public interface InterceptorHook {
    ...
    /**
     * 获取拦截名,可以同时获取多个拦截， 如 return new String[]{"noneoneblog.web.controller.desk.group.GroupVidewController"};
     * <p>
     * 也可以拦截Controller里面的方法，格式如：return new String[]{"noneoneblog.web.controller.desk.group.GroupVidewController#view"};
     *
     * @return
     */
